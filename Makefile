...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name cluster-api-provider-metal-stack-builder
	$(CONTAINER_TOOL) buildx use cluster-api-provider-metal-stack-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm cluster-api-provider-metal-stack-builder
	rm Dockerfile.cross
