...
func (in *Firewall) DeepCopyInto(out *Firewall) {
	*out = *in
	...
	if in.RateLimits != nil {
		...
		*out = make([]v2.RateLimit, len(*in))
		copy(*out, *in)
	}
	if in.EgressRules != nil {
		in, out := &in.EgressRules, &out.EgressRules
		*out = make([]v2.EgressRuleSNAT, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.LogAcceptedConnections != nil {
		in, out := &in.LogAcceptedConnections, &out.LogAcceptedConnections
		*out = new(bool)
		**out = **in
	}
}
