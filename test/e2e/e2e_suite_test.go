...
import (
	...
	"github.com/metal-stack/cluster-api-provider-metal-stack/test/utils"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting cluster-api-provider-metal-stack integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	cmd = exec.Command("make", "docker-build", fmt.Sprintf("IMG=%s", projectImage)) //nolint
	_, err = utils.Run(cmd)
